...
config.background = {
  {
    source = { File = {path = 'C:/Users/Administrator/.config/bg-images/bg_parallax_stars_1536x3840.png', speed = 0.2}},
    opacity = 100,
    width = "100%",
    hsb = {brightness = 0.5},
  ...
  {
    source = { File = {path = 'C:/Users/Administrator/.config/bg-images/bg_parallax_spacedust_1536x3840.png', speed = 0.2}},
    opacity = 2,
    width = "100%",
    hsb = {brightness = 0.5},
